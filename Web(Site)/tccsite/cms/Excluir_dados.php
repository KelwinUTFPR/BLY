                  ...
                  <div class="col-lg-6"><!-- div para alterar o lado    -->
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"> Excluir conteúdo </strong>
                        </div>
                        <div class="card-body">
                    
       
         
						 <form action="Excluir2.php" method="post" enctype="multipart/form-data">
						 ...
						 <input type="submit" class="btn btn-danger btn-sm" value="EXCLUIR"></input>
